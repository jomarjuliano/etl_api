...
def get_anunciante(campanha):
    if ('VAREJO-NAC' in campanha) or ('ALP_MADRUGOL-NACIONAL' in campanha) or ('ALP_ACAO-FIM-DE-SEMANA' in campanha):
        anunciante = 'GOL'
    elif ('VAREJO-INTER' in campanha) or ('ALP_MADRUGOL-INTERNACIONAL' in campanha):
        anunciante = 'GOL_INTERNACIONAL'
    elif 'MARCA' in campanha:
        anunciante = 'GOL_MARCA'
    elif 'RECEITAS-AUXILIARES' in campanha:
        anunciante = 'GOL_RA'
    elif 'KLM-AF' in campanha:
        anunciante = 'GOL_KLM-AF'
    elif 'VOEBIZ' in campanha:
        anunciante = 'GOL_VOEBIZ'
    elif 'GOLLOG' in campanha:
        anunciante = 'GOL_LOG'
    else:
        anunciante = 'OUTROS'
    return anunciante
